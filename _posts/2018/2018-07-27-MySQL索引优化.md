...
<font color=red>注意，这两种称呼是对建立索引技巧的一种*称呼*，并非索引的*类型*。</font>
...
也就是，name_city_age(vc_Name(10),vc_City,i_Age) 从左到右进行索引，<font color=red>如果没有左前索引Mysql不执行索引查询。</font>
...
![多表关联查询](https://zealcheng.github.io/assets/posts_images/2018/2018-07-27-MySQL索引优化/1.jpg)
...
转自：<http://www.runoob.com/w3cnote/mysql-index.html>{:target="_blank"}